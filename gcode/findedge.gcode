...
G91 G0 X-{{margin}}; Move 60mm to left (x)
...
G91 G0 Y-{{margin}}; Move 60mm to front (y)
G91 G0 X{{margin}}; Move 60mm to right (x)
G91 G0 Z-6; Move 6mm down (z)
G38.2 Y50 F100; Prove Y
G92 Y{{offset}}; Set zero Y (-10.10mm calibration plate thickness -1/2 tool thickness)
G91 G0 Y-3; Move 3mm to front (y)
G91 G0 Z20; Lift 20mm up (z)